<%@ Page Language="C#" AutoEventWireup="true" CodeFile="playup.aspx.cs" Inherits="playup" %>
...
<body>
    ...
    <div class="main">
            ...
            <dl class="rjdl">
                <dt class="lx">
                    <ul>
                        ...
                        <li><a href="playup.aspx">奋斗日记</a></li>
                    </ul>
                </dt>
        ...
        <div class="mainr">
            <dl class="rjdl">
                <dt class="lx"><span>奋斗语</span></dt>
                <%for (int i = 0; i < ds_playup_recommend.Rows.Count; i++)
                  { %>
                <dd class="lhotdiary">
                    <li class="title"><a href="<%=ds_playup_recommend.Rows[i]["c_url"].ToString()%>">
                        <%=ds_playup_recommend.Rows[i]["c_title"].ToString()%></a></li>
                </dd>
                <%} %>
            </dl>
        </div>
