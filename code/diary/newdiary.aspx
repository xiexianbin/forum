<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newdiary.aspx.cs" Inherits="newdiary" %>
...
<body>
    ...
    <div class="main">
            ...
            <dl class="rjdl">
                <dt class="lx">
                    <ul>
                        ...
                        <li><a href="newdiary.aspx">最新日记</a></li>
                    </ul>
                </dt>
        ...
        <div class="mainr">
            <dl class="rjdl">
                <dt class="lx"><span>心语</span></dt>
                <%for (int i = 0; i < ds_newsd_recommend.Rows.Count; i++)
                  { %>
                <dd class="lhotdiary">
                    <li class="title"><a href="<%=ds_newsd_recommend.Rows[i]["c_url"].ToString()%>">
                        <%=ds_newsd_recommend.Rows[i]["c_title"].ToString()%></a></li>
                </dd>
                <%} %>
            </dl>
        </div>
