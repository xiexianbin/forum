...
<body>
    ...
    <div class="main">
                    ...
                    <ul>
                        <li>
                            <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%=ds_view_p["d_id"].ToString() %>'
                                OnCommand="LinkButton1_Command">赞(<%=ds_view_p["d_good"].ToString() %>)</asp:LinkButton></li>
                        <li>评论(<%=ds_view_p["com_number"].ToString() %>)</li>
                        <li class="count">浏览(<%= ds_view_p["read_number"].ToString()%>)</li>
                    </ul>
                </dd>
                <dd>
                    评论列表：</dd>
                ...
                <dd>
                    <td width="600">
                        ...
                        <label>
                            <ul>
                                <li>
                                    <asp:Button ID="btSave" runat="server" Text="发表评论" OnClick="btSave_Click" /></li>
                            </ul>
                        </label>
                        <p>
                            <br />
        ...
        <div class="mainr">
            <dl class="rjdl">
                <dt class="lx"><span>你不懂得哦</span></dt>
