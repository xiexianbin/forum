<%@ Page Language="C#" AutoEventWireup="true" CodeFile="motdiary.aspx.cs" Inherits="motdiary" %>
...
<body>
    ...
    <div class="main">
            ...
            <dl class="rjdl">
                <dt class="lx">
                    <ul>
                        ...
                        <li><a href="motdiary.aspx">励志日记</a></li>
                    </ul>
                </dt>
        ...
        <div class="mainr">
            <dl class="rjdl">
                <dt class="lx"><span>励志语</span></dt>
                <%for (int i = 0; i < ds_mot_recommend.Rows.Count; i++)
                  { %>
                <dd class="lhotdiary">
                    <li class="title"><a href="<%=ds_mot_recommend.Rows[i]["c_url"].ToString()%>">
                        <%=ds_mot_recommend.Rows[i]["c_title"].ToString()%></a></li>
                </dd>
                <%} %>
            </dl>
        </div>
