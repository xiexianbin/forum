<%@ Page Language="C#" AutoEventWireup="true" CodeFile="manage_sugreading_sug.aspx.cs"
    Inherits="admin_recommend_manage_sugreading_sug" %>
...
<body>
    ...
    <div id="header">
        ...
        <span class="headerspan">>></span>
        <li class="headerlili">推荐阅读超链接管理</li>
    </div>
    <div class="main">
        <div class="main_add">
            <div class="main_ceng">
        ...
        <div class="main_other">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="c_id"
                CellPadding="4" ForeColor="#333333" GridLines="None" OnRowDeleting="GridView1_RowDeleting1"
                Width="800px">
