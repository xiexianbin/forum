<%@ Page Language="C#" AutoEventWireup="true" CodeFile="manege_mot_sug.aspx.cs" Inherits="admin_recommend_manege_mot_sug" %>
...
<body>
    ...
    <div id="header">
        ...
        <span class="headerspan">>></span>
        <li class="headerlili">励志页超链接管理</li>
    </div>
    <div class="main">
        <div class="main_add">
            <div class="main_ceng">
        ...
        <div class="main_other">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="c_id"
                ...
                onrowdeleting="GridView_RowDeleting1" Width="800px">
