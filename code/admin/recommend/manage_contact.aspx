<%@ Page Language="C#" AutoEventWireup="true" CodeFile="manage_contact.aspx.cs" Inherits="admin_recommend_manage_contact" %>
    ...
    <div class="main">
        ...
        <div class="main_other">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="c_id"
                ...
                onrowdeleting="GridView_RowDeleting" Width="800px">
