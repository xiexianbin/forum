<%@ Page Language="C#" AutoEventWireup="true" CodeFile="about_us.aspx.cs" Inherits="admin_news_about_us" %>
    ...
    <div>
        <div style="text-align: center">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                DataKeyNames="n_id" ForeColor="#333333" GridLines="None" OnRowDeleting="GridView1_RowDeleting"
                Width="800px">
            ...
            <br />
            <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">添加关于我们</asp:LinkButton>
        </div>
    </div>
    </form>
</body>
