<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wr_years.aspx.cs" Inherits="admin_news_wr_years" %>
...
<body>
    ...
    <div>
        <div style="text-align: center">
            ...
            <br />
            <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">风雨那些年</asp:LinkButton>
        </div>
    </div>
    </form>
</body>
