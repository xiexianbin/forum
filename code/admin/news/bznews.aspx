<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bznews.aspx.cs" Inherits="admin_news_bznews" %>
    ...
    <div style="text-align: center">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="n_other" HeaderText="备注信息" 
                    SortExpression="n_other" />
