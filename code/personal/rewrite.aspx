<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rewrite.aspx.cs" Inherits="personal_rewrite" %>
...
<head id="Head1" runat="server">
    ...
    <link href="../style/write_diary_css.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <div class="main">
        <div class="title">
            <li class="write_left">标题：</li>
            <li class="write_right">
                <input name="title1" type="text" id="title1" runat="server" /></li>
        </div>
        <div class="type">
            <li class="write_left">类别：</li>
            <li class="write_right">
                ...
                <span id="editor_toolbar_btn_container" style="margin: 0 0 0 10px;"></span></li>
        </div>
        <div class="content">
            <CKEditor:CKEditorControl ID="CKEditor" runat="server" Height="450px" Width="958px"
                BasePath="../ckeditor"></CKEditor:CKEditorControl>
        </div>
        <div class="write_diary_button">
            <ul>
                <li>
                ...
                <li>
                    <asp:Button ID="btpublic" runat="server" Text="更新日记" OnClick="btpublic_Click" /></li>
                <li>
