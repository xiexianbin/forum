<%@ Page Language="C#" AutoEventWireup="true" CodeFile="manage_diary_s.aspx.cs" Inherits="manage_diary_s" %>
        ...
        <div class="pmainr">
            ...
            <dl class="rjdl">
                <asp:Repeater ID="Repeater1" runat="server">
                    <ItemTemplate>
                        <dd class="bigdd_per">
                            <li class="title_per"><a href="manage_diary_s_v.aspx?id=<%#Eval("d_id") %>">
                                <%#Eval("d_title") %></a></li>
                            <li class="type">
                                <%#Eval("d_type") %></li>
                            <li class="time">
                        ...
                        <dd class="lastList">
                            <ul>
                                ...
                                <li>
                                    <asp:LinkButton ID="LinkButton2" CommandName="id" CommandArgument='<%#Eval("d_id") %>'
                                        runat="server" OnCommand="LinkButton_spulbic">公开</asp:LinkButton></li>
                                <li><a href='rewrite.aspx?id=<%#Eval("d_id") %>'>编辑</a></li>
                                <li><a href='manage_diary_s_v.aspx?id=<%#Eval("d_id") %>'>查看</a></li>
                            </ul>
                        </dd>
                    </ItemTemplate>
                </asp:Repeater>
