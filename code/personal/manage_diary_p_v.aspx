<%@ Page Language="C#" AutoEventWireup="true" CodeFile="manage_diary_p_v.aspx.cs"
    Inherits="manage_diary_p_v" %>
    ...
    <div class="main">
        <div class="pmainr">
            ...
            <dl class="rjdl">
                ...
                <dd class="bigdd_per">
                    <li class="title_per">
                        <%=ds_p_v["d_title"].ToString()%></li>
                    <li class="type">
                        <%=ds_p_v["d_type"].ToString()%></li>
                    <li class="time">
                        <%=ds_p_v["d_time"].ToString() %></li>
                </dd>
                <dd class="text">
                    <%=ds_p_v["d_text"].ToString() %>
                </dd>
                <dd class="lastList">
                    <ul>
                        <li>
                            <asp:LinkButton ID="LinkButton1" CommandArgument='<%=ds_p_v["d_id"].ToString() %>'
                                runat="server" OnCommand="LinkButton_cdelete">删除</asp:LinkButton></li>
                        <li>
                            <asp:LinkButton ID="LinkButton2" CommandName="id" CommandArgument='<%=ds_p_v["d_id"].ToString() %>'
                                runat="server" OnCommand="LinkButton_csec">隐藏</asp:LinkButton></li>
                        <li><a href="rewrite.aspx?id=<%=ds_p_v["d_id"].ToString() %>">编辑</a></li>
                    </ul>
                </dd>
                <dd>
                    评论列表：</dd>
