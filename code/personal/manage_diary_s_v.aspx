<%@ Page Language="C#" AutoEventWireup="true" CodeFile="manage_diary_s_v.aspx.cs"
    Inherits="manage_diary_s_v" %>
            ...
            <dl class="rjdl">
                <dt class="lx">
                    <ul>
                        ...
                        <li><a href="personal.aspx">个人中心>></a></li>
                        <li><a href="manage_diary.aspx">日记管理>></a></li>
                        <li><a href="manege_diary_s.aspx">私密日记</a></li>
                    </ul>
                </dt>
            </dl>
            <dl>
                <dd class="mage_s_p">
                    <ul>
                        <li><a href="manage_diary_p.aspx">公开日记</a></li>
                        <li><a href="manage_diary_s.aspx">私密日记</a></li>
                        <li><a href="manage_diary_other.aspx">草稿箱</a></li>
                    </ul>
                </dd>
            </dl>
            <dl class="rjdl">
                <%--d--%>
                <dd class="bigdd_per">
                    <%-- <li class="image">头像</li>--%>
                    <%--<li class="author"><a href="user.aspx?id=<%=ds_s_v["u_name"].ToString() %>">
                        <%=ds_s_v["u_name"].ToString()%></a></li>--%>
                    <li class="title_per">
                        <%=ds_s_v["d_title"].ToString()%></li>
                    <li class="type">
                        <%=ds_s_v["d_type"].ToString()%></li>
                    <li class="time">
                        <%=ds_s_v["d_time"].ToString() %></li>
                </dd>
                <dd class="text">
                    <%=ds_s_v["d_text"].ToString() %>
                </dd>
                <dd class="lastList">
                    <ul>
                        <li>
                            <asp:LinkButton ID="LinkButton1" CommandName="id" CommandArgument='<%=ds_s_v["d_id"].ToString() %>'
                                runat="server" OnCommand="LinkButton_cdelete">删除</asp:LinkButton></li>
                        <li>
                            <asp:LinkButton ID="LinkButton2" CommandName="id" CommandArgument='<%=ds_s_v["d_id"].ToString() %>'
                                runat="server" OnCommand="LinkButton_cpublic">公开</asp:LinkButton></li>
                        <li><a href="rewrite.aspx?id=<%=ds_s_v["d_id"].ToString() %>">编辑</a></li>
                    </ul>
                </dd>
                <dd>
                    评论列表：</dd>
                            ...
                            <ul>
                                <li>
                                    <asp:LinkButton ID="LinkButton3" CommandName="id_del" CommandArgument='<%#Eval("c_id") %>' runat="server"
                                        OnCommand="LinkButton_delete_com">删除</asp:LinkButton></li>
                            </ul>
                        </dd>
                    </ItemTemplate>
                </asp:Repeater>
