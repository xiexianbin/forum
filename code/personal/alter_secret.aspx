<%@ Page Language="C#" AutoEventWireup="true" CodeFile="alter_secret.aspx.cs" Inherits="alter_secret" %>
            ...
            <dl class="rjdl">
                <dt class="lx">
                    <ul>
                        ...
                        <li><a href="personal.aspx">个人中心>></a></li>
                        <li><a href="alter_secret.aspx">修改密码</a></li>
                    </ul>
                </dt>
                <dd>
                    <table width="453" border="0">
                        <tr>
                            ...
                            <td width="175">
                                <label>
                                    <asp:TextBox ID="his_sec" type="password" runat="server"></asp:TextBox>
                                </label>
                            </td>
                            <td width="115">
                                &nbsp;
                        ...
                        <tr>
                            ...
                            <td>
                                <label>
                                    <asp:TextBox ID="news_sec" type="password" runat="server"></asp:TextBox>
                                </label>
                            </td>
                            <td>
                                &nbsp;
                        ...
                        <tr>
                            ...
                            <td>
                                <label>
                                    <asp:TextBox ID="news_re_sec" type="password" runat="server"></asp:TextBox>
                                </label>
                            </td>
                            <td>
                                &nbsp;
                        ...
                        <tr>
                            ...
                            <td>
                                <label>
                                    <asp:Button ID="Button2" runat="server" Text="修改" OnCommand="Button2_Command" />
                                </label>
                                <label>
                                    <asp:Button ID="Button3" runat="server" Text="重设" />
                                </label>
                            </td>
                            <td>
                                &nbsp;
