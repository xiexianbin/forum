            ...
            <dl class="rjdl">
                <dt class="lx">
                    <ul>
                        ...
                        <li><a href="manage_diary_other.aspx">草稿日记</a></li>
                    </ul>
                </dt>
            </dl>
            <dl>
                    ...
                    <ul>
                        <li>
                            <asp:LinkButton ID="LinkButton_o_vdelete" runat="server" CommandName="id" CommandArgument='<%=ds_o_v["d_id"].ToString() %>'
                                OnCommand="LinkButton_o_vdelete_Command">删除</asp:LinkButton></li>
                        <li>
                            <asp:LinkButton ID="LinkButton_o_vpulic" runat="server" CommandName="id" CommandArgument='<%=ds_o_v["d_id"].ToString() %>'
                                OnCommand="LinkButton_o_vpulic_Command">公开</asp:LinkButton></li>
                        <li>
                            <asp:LinkButton ID="LinkButton_o_vhide" runat="server" CommandName="id" CommandArgument='<%=ds_o_v["d_id"].ToString() %>'
                                OnCommand="LinkButton_o_vhide_Command">隐藏</asp:LinkButton></li>
                        <li><a href="rewrite.aspx?id=<%=ds_o_v["d_id"].ToString() %>">编辑</a></li>
                    </ul>
                </dd>
                <dd>
                    评论列表：</dd>
