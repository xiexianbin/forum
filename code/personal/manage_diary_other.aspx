<%@ Page Language="C#" AutoEventWireup="true" CodeFile="manage_diary_other.aspx.cs"
    Inherits="manage_diary_other" %>
        ...
        <div class="pmainr">
            ...
            <dl class="rjdl">
                <asp:Repeater ID="Repeater1" runat="server">
                    <ItemTemplate>
                        <dd class="bigdd_per">
                            <li class="title_per"><a href="manage_diary_o_v.aspx?id=<%#Eval("d_id") %>">
                                <%#Eval("d_title") %></a></li>
                            <li class="type">
                                <%#Eval("d_type") %></li>
                            <li class="time">
                        ...
                        <dd class="lastList">
                            <ul>
                                <li>
                                    <asp:LinkButton ID="LinkButton1_odelete" runat="server" CommandName="id" CommandArgument='<%#Eval("d_id") %>'
                                        OnCommand="LinkButton1_odelete_Command">删除</asp:LinkButton></li>
                                <li>
                                    <asp:LinkButton ID="LinkButton1_opublic" runat="server" CommandName="id" CommandArgument='<%#Eval("d_id") %>'
                                        OnCommand="LinkButton1_opublic_Command">公开</asp:LinkButton></li>
                                <li>
                                    <asp:LinkButton ID="LinkButton1_ohide" runat="server" CommandName="id" CommandArgument='<%#Eval("d_id") %>'
                                        OnCommand="LinkButton1_ohide_Command">隐藏</asp:LinkButton></li>
                                <li><a href="rewrite.aspx?id=<%#Eval("d_id") %>">编辑</a></li>
                                <li><a href="manage_diary_o_v.aspx?id=<%#Eval("d_id") %>">查看</a></li>
                            </ul>
                        </dd>
                    </ItemTemplate>
                </asp:Repeater>
