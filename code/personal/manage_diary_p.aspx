<%@ Page Language="C#" AutoEventWireup="true" CodeFile="manage_diary_p.aspx.cs" Inherits="manage_diary_p" %>
            ...
            <dl class="rjdl">
                <asp:Repeater ID="Repeater1" runat="server">
                    <ItemTemplate>
                        <dd class="bigdd_per">
                            <ul>
                                <li class="title_per"><a href="manage_diary_p_v.aspx?id=<%#Eval("d_id") %>">
                                    <%#Eval("d_title") %></a></li>
                                <li class="type">
                                    <%#Eval("d_type") %></li>
                                <li class="time">
                            ...
                            <ul>
                                <li>
                                    <asp:LinkButton ID="LinkButton1" CommandName="id" CommandArgument='<%#Eval("d_id") %>'
                                        clickID="" runat="server" OnCommand="LinkButton_cdelete">删除</asp:LinkButton></li>
                                <li>
                                ...
                                <li><a href="manage_diary_p_v.aspx?id=<%#Eval("d_id") %> ">查看</a></li>
                            </ul>
                        </dd>
                    </ItemTemplate>
                </asp:Repeater>
