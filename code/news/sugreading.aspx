<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sugreading.aspx.cs" Inherits="sugreading" %>
...
<body>
    ...
    <div id="header">
        ...
        <div id="nav">
            <ul>
                ...
                <li><a href="sugreading.aspx">推荐阅读</a><span></span></li>
    ...
    <div class="main">
            ...
            <dl class="rjdl">
                <dt class="lx">
                    <ul>
                        ...
                        <li><a href="sugreading.aspx">推荐阅读</a></li>
                    </ul>
                </dt>
                <%for (int i = 0; i < ds_sugreading.Rows.Count; i++)
                  { %>
                <dd class="sugreading_news">
                    <li class="sugreading_title"><a href="sugreading_v.aspx?id=<%=ds_sugreading.Rows[i]["n_id"].ToString() %>">
                        <%=ds_sugreading.Rows[i]["n_title"].ToString()%></a></li>
                    <li class="sugreading_time">
                        <%=ds_sugreading.Rows[i]["n_time"].ToString()%></li>
                </dd>
                <%} %>
        ...
        <div class="mainr">
            <dl class="rjdl">
                <dt class="lx"><span>联系我们</span></dt>
                <%for (int i = 0; i < ds_sug_recommend.Rows.Count; i++)
                  { %>
                <dd class="lhotdiary">
                    <li class="title"><a href="<%=ds_sug_recommend.Rows[i]["c_url"].ToString()%>">
                        <%=ds_sug_recommend.Rows[i]["c_title"].ToString()%></a></li>
                </dd>
                <%} %>
            </dl>
        </div>
