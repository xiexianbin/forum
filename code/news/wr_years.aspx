<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wr_years.aspx.cs" Inherits="news_wr_years" %>
        ...
        <div class="rfmain">
            <dl class="rjdl">
                <dd class="news_s_title">
                    <%=ds_news["n_title"].ToString()%></dt>
                    <dd class="news_s_time">
                        发表人：<%=ds_news["ad_user"].ToString()%>&nbsp;&nbsp; 发表时间：<%=ds_news["n_time"].ToString()%>
