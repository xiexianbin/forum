<%@ Page Language="C#" AutoEventWireup="true" CodeFile="kynews.aspx.cs" Inherits="kynews" %>
...
<body>
    ...
    <div class="main">
        ...
        <div class="rfmain">
            ...
            <dl>
                <%for (int i = 0; i < ds_news_ky.Rows.Count; i++)
                  { %>
                <dd class="NewsPages">
                    <a href="news.aspx?id=<%=ds_news_ky.Rows[i]["n_id"].ToString() %>">
                        <li class="NewsPages_title">
                            <%=ds_news_ky.Rows[i]["n_title"].ToString()%></li></a>
