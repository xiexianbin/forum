<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bznews.aspx.cs" Inherits="bznews" %>
...
<body>
            ...
            <div class="rtop">
                <div class="login" id="getIn">
                    <ul>
                        ...
                        <li class="inpu">
                            <input type="text" id="username" runat="server" accesskey="l" tabindex="1" size="12" /></li>
                        <li class="laber">密码：</li>
                        <li class="inpu">
                            <input type="password" id="secret" size="12" runat='server' /></li>
                        <li class="button">
    ...
    <div class="main">
        ...
        <div class="rfmain">
            <dl class="rjdl">
                <dt><span>本站新闻</span></dt>
            </dl>
            <dl>
                <%for (int i = 0; i < ds_news_bz.Rows.Count; i++)
                  { %>
                <dd class="NewsPages">
                    <li class="NewsPages_title"><a href="news.aspx?id=<%=ds_news_bz.Rows[i]["n_id"].ToString() %>">
                        <%=ds_news_bz.Rows[i]["n_title"].ToString()%></a></li>
                    <li class="NewsPages_time">
                        <%=ds_news_bz.Rows[i]["n_time"].ToString()%></li></dd>
                <% }%>
